module cetus::i64 {
    ...
    public fun abs(arg0: I64) : I64 {
        if (sign(arg0) == 0) {
            ...
            assert!(arg0.bits > 9223372036854775808, 0x1::error::invalid_argument(0));
    ...
    public fun from(arg0: u64) : I64 {
        assert!(arg0 <= 9223372036854775807, 0x1::error::invalid_argument(0));
        I64{bits: arg0}
    }
    ...
    public fun neg_from(arg0: u64) : I64 {
        assert!(arg0 <= 9223372036854775808, 0x1::error::invalid_argument(0));
        if (arg0 == 0) {
            I64{bits: arg0}
        } else {
