module tap::clmm_math {
    ...
    public fun get_amount_by_liquidity(
        ...
        if (integer_mate::i64::lt(arg2, arg0)) {
            (get_delta_a(
                tap::tick_math::get_sqrt_price_at_tick(arg0),
                tap::tick_math::get_sqrt_price_at_tick(arg1),
                arg4,
                arg5
            ), 0)
        } else if (integer_mate::i64::lt(arg2, arg1)) {
            (get_delta_a(arg3, tap::tick_math::get_sqrt_price_at_tick(arg1), arg4, arg5), get_delta_b(
                tap::tick_math::get_sqrt_price_at_tick(arg0),
                arg3,
                arg4,
                arg5
    ...
    public fun get_delta_a(arg0: u128, arg1: u128, arg2: u128, arg3: bool): u64 {
        ...
        let (v1, v2) = integer_mate::math_u256::checked_shlw(integer_mate::full_math_u128::full_mul_v2(arg2, v0));
        if (v2) {
            abort 3
        };
        (integer_mate::math_u256::div_round(v1, integer_mate::full_math_u128::full_mul_v2(arg0, arg1), arg3) as u64)
    }
    ...
    public fun get_delta_b(arg0: u128, arg1: u128, arg2: u128, arg3: bool): u64 {
        ...
        let v1 = integer_mate::full_math_u128::full_mul_v2(arg2, v0);
    ...
    public fun get_delta_down_from_output_v2(arg0: u128, arg1: u128, arg2: u128, arg3: bool): u256 {
        ...
        if (arg3) {
            integer_mate::full_math_u128::full_mul_v2(arg2, v0) >> 64
        } else {
            let (v2, v3) = integer_mate::math_u256::checked_shlw(integer_mate::full_math_u128::full_mul_v2(arg2, v0));
            if (v3) {
                abort 3
            };
            integer_mate::math_u256::div_round(v2, integer_mate::full_math_u128::full_mul_v2(arg0, arg1), false)
        }
    }
    ...
    public fun get_delta_up_from_input_v2(arg0: u128, arg1: u128, arg2: u128, arg3: bool): u256 {
        ...
        if (arg3) {
            ...
            integer_mate::math_u256::div_round(v2, integer_mate::full_math_u128::full_mul_v2(arg0, arg1), true)
        } else {
            let v4 = integer_mate::full_math_u128::full_mul_v2(arg2, v0);
    ...
    public fun get_liquidity_from_a(arg0: u128, arg1: u128, arg2: u64, arg3: bool): u128 {
        ...
        (integer_mate::math_u256::div_round(
            (integer_mate::full_math_u128::full_mul_v2(arg0, arg1) >> 64) * (arg2 as u256),
            (v0 as u256),
            arg3
        ) as u128)
    }
    ...
    public fun get_liquidity_from_amount(
        ...
        current_index: integer_mate::i64::I64,
        ...
        let liquidity = if (fix_amount_a) {
            amount_a = amount;
            if (integer_mate::i64::lt(current_index, lower_index)) {
                get_liquidity_from_a(
                    tap::tick_math::get_sqrt_price_at_tick(lower_index),
                    tap::tick_math::get_sqrt_price_at_tick(
                        upper_index
                    ),
                    amount,
                    false
                ...
                assert!(integer_mate::i64::lt(current_index, upper_index), 6);
                let liquidity = get_liquidity_from_a(
                    current_sqrt_price,
                    tap::tick_math::get_sqrt_price_at_tick(upper_index),
                    amount,
                    false);
            ...
            amount_b = amount;
            if (integer_mate::i64::gte(current_index, upper_index)) {
                ...
                assert!(integer_mate::i64::gte(current_index, lower_index), 6);
                let liquidity = get_liquidity_from_b(tap::tick_math::get_sqrt_price_at_tick(lower_index),
    ...
    public fun get_next_sqrt_price_a_up(arg0: u128, arg1: u128, arg2: u64, arg3: bool): u128 {
        ...
        let (v0, v1) = integer_mate::math_u256::checked_shlw(integer_mate::full_math_u128::full_mul_v2(arg0, arg1));
        if (v1) {
            abort 3
        };
        let v2 = if (arg3) {
            (integer_mate::math_u256::div_round(
                v0,
                ((arg1 as u256) << 64) + integer_mate::full_math_u128::full_mul_v2(arg0, (arg2 as u128)),
                true
            ) as u128)
        } else {
            (integer_mate::math_u256::div_round(
        ...
        if (v2 > tap::tick_math::max_sqrt_price()) {
            abort 1
        };
        if (v2 < tap::tick_math::min_sqrt_price()) {
            abort 2
        };
        v2
    }
    ...
    public fun get_next_sqrt_price_b_down(arg0: u128, arg1: u128, arg2: u64, arg3: bool): u128 {
        ...
        if (v0 > tap::tick_math::max_sqrt_price()) {
            abort 1
        };
        if (v0 < tap::tick_math::min_sqrt_price()) {
            abort 2
        };
        v0
    }
