module cetus::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &signer, arg1: u64, arg2: u128, arg3: 0x1::string::String) : address acquires PoolOwner, Pools {
        cetus::config::assert_pool_create_authority(arg0);
        let v0 = if (0x1::string::length(&arg3) == 0 || !cetus::config::allow_set_position_nft_uri(arg0)) {
        ...
        assert!(arg2 >= cetus::tick_math::min_sqrt_price() && arg2 <= cetus::tick_math::max_sqrt_price(), 2);
        let v1 = new_pool_id<T0, T1>(arg1);
        let v2 = 0x1::account::create_signer_with_capability(&borrow_global<PoolOwner>(@cetus).signer_capability);
        ...
        let v8 = borrow_global_mut<Pools>(@cetus);
        v8.index = v8.index + 1;
        ...
        let v9 = CreatePoolEvent{
            ...
            pool_address             : v7,
            position_collection_name : cetus::pool::new<T0, T1>(&v6, arg1, arg2, v8.index, v0, v5),
    ...
    public fun get_pool<T0, T1>(arg0: u64) : 0x1::option::Option<address> acquires Pools {
        let v0 = borrow_global<Pools>(@cetus);
    ...
    fun new_pool_seed<T0, T1>(arg0: u64) : PoolId {
        let v0 = cetus::utils::compare_coin<T0, T1>();
