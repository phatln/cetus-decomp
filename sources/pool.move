module cetus::pool {
    ...
    public fun new<T0, T1>(arg0: &signer, arg1: u64, arg2: u128, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::account::SignerCapability) : 0x1::string::String {
        assert!(0x1::type_info::type_of<T0>() != 0x1::type_info::type_of<T1>(), 37);
        let v0 = cetus::position_nft::create_collection<T0, T1>(arg0, arg1, 0x1::string::utf8(b"Cetus Liquidity Position"), arg4);
        let v1 = Pool<T0, T1>{
            index                       : arg3,
            collection_name             : v0,
    ...
    public fun add_liquidity<T0, T1>(arg0: address, arg1: u128, arg2: u64) : AddLiquidityReceipt<T0, T1> acquires Pool {
        assert!(arg1 != 0, 11);
        add_liquidity_internal<T0, T1>(arg0, arg2, false, arg1, 0, false)
    }

    public fun add_liquidity_fix_coin<T0, T1>(arg0: address, arg1: u64, arg2: bool, arg3: u64) : AddLiquidityReceipt<T0, T1> acquires Pool {
        assert!(arg1 > 0, 6);
        add_liquidity_internal<T0, T1>(arg0, arg3, true, 0, arg1, arg2)
    }

    fun add_liquidity_internal<T0, T1>(arg0: address, arg1: u64, arg2: bool, arg3: u128, arg4: u64, arg5: bool) : AddLiquidityReceipt<T0, T1> acquires Pool {
        let v0 = borrow_global_mut<Pool<T0, T1>>(arg0);
        assert_status<T0, T1>(v0);
        update_rewarder<T0, T1>(v0);
        let (v1, v2) = get_position_tick_range_by_pool<T0, T1>(v0, arg1);
        let (v3, v4) = get_fee_in_tick_range<T0, T1>(v0, v1, v2);
        let v5 = 0x1::table::borrow_mut<u64, Position>(&mut v0.positions, arg1);
        update_position_fee_and_reward(v5, v3, v4, get_reward_in_tick_range<T0, T1>(v0, v1, v2));
        let (v6, v7, v8) = if (arg2) {
            let (v9, v10, v11) = cetus::clmm_math::get_liquidity_from_amount(v1, v2, v0.current_tick_index, v0.current_sqrt_price, arg4, arg5);
            (v10, v11, v9)
        } else {
            let (v12, v13) = cetus::clmm_math::get_amount_by_liquidity(v1, v2, v0.current_tick_index, v0.current_sqrt_price, arg3, true);
            (v12, v13, arg3)
        };
        update_position_liquidity(v5, v8, true);
        upsert_tick_by_liquidity<T0, T1>(v0, v1, v8, true, false);
        upsert_tick_by_liquidity<T0, T1>(v0, v2, v8, true, true);
        let (v14, v15) = if (cetus::i64::gte(v0.current_tick_index, v1) && cetus::i64::lt(v0.current_tick_index, v2)) {
            cetus::math_u128::overflowing_add(v0.liquidity, v8)
        } else {
            (v0.liquidity, false)
        };
        assert!(!v15, 7);
        ...
        0x1::event::emit_event<AddLiquidityEvent>(&mut v0.add_liquidity_events, v16);
    ...
    fun borrow_mut_tick_with_default(arg0: &mut 0x1::table::Table<u64, 0x1::bit_vector::BitVector>, arg1: &mut 0x1::table::Table<cetus::i64::I64, Tick>, arg2: u64, arg3: cetus::i64::I64) : &mut Tick {
    ...
    fun borrow_tick<T0, T1>(arg0: &Pool<T0, T1>, arg1: cetus::i64::I64) : 0x1::option::Option<Tick> {
        let (v0, _) = tick_position(arg1, arg0.tick_spacing);
        ...
        0x1::option::some<Tick>(*0x1::table::borrow<cetus::i64::I64, Tick>(&arg0.ticks, arg1))
    }
    ...
    public fun check_position_authority<T0, T1>(arg0: &signer, arg1: address, arg2: u64) acquires Pool {
        ...
        assert!(0x3::token::balance_of(0x1::signer::address_of(arg0), 0x3::token::create_token_id(0x3::token::create_token_data_id(0x1::account::get_signer_capability_address(&v0.signer_cap), v0.collection_name, cetus::position_nft::position_name(v0.index, arg2)), 0)) == 1, 28);
    }
    ...
    public fun collect_fee<T0, T1>(arg0: &signer, arg1: address, arg2: u64, arg3: bool) : (0x1::coin::Coin<T0>, 0x1::coin::Coin<T1>) acquires Pool {
        check_position_authority<T0, T1>(arg0, arg1, arg2);
        let v0 = borrow_global_mut<Pool<T0, T1>>(arg1);
        assert_status<T0, T1>(v0);
        let v1 = if (arg3) {
    ...
    public fun collect_protocol_fee<T0, T1>(arg0: &signer, arg1: address) : (0x1::coin::Coin<T0>, 0x1::coin::Coin<T1>) acquires Pool {
    ...
    public fun collect_rewarder<T0, T1, T2>(arg0: &signer, arg1: address, arg2: u64, arg3: u8, arg4: bool) : 0x1::coin::Coin<T2> acquires Pool {
        check_position_authority<T0, T1>(arg0, arg1, arg2);
        let v0 = borrow_global_mut<Pool<T0, T1>>(arg1);
        assert_status<T0, T1>(v0);
        update_rewarder<T0, T1>(v0);
    ...
    public fun fetch_ticks<T0, T1>(arg0: address, arg1: u64, arg2: u64, arg3: u64) : (u64, u64, vector<Tick>) acquires Pool {
        let v0 = borrow_global_mut<Pool<T0, T1>>(arg0);
            ...
            if (0x1::table::contains<u64, 0x1::bit_vector::BitVector>(&v0.tick_indexes, v2)) {
                ...
                while (v4 >= 0 && v4 < 1000) {
                    if (0x1::bit_vector::is_index_set(v6, v4)) {
                        let v7 = v5 + 1;
                        v5 = v7;
                        0x1::vector::push_back<Tick>(&mut v3, *0x1::table::borrow<cetus::i64::I64, Tick>(&v0.ticks, cetus::i64::sub(cetus::i64::from((1000 * v2 + v4) * v1), tick_max(v1))));
                        if (v7 == arg3) {
                            return (v2, v4, v3)
                        };
                    };
    ...
    fun get_fee_in_tick_range<T0, T1>(arg0: &Pool<T0, T1>, arg1: cetus::i64::I64, arg2: cetus::i64::I64) : (u128, u128) {
        let v0 = borrow_tick<T0, T1>(arg0, arg1);
        let v1 = borrow_tick<T0, T1>(arg0, arg2);
        let v2 = arg0.current_tick_index;
        let (v3, v4) = if (0x1::option::is_none<Tick>(&v0)) {
            (arg0.fee_growth_global_a, arg0.fee_growth_global_b)
        } else {
            let v5 = 0x1::option::borrow<Tick>(&v0);
            if (cetus::i64::lt(v2, arg1)) {
                (cetus::math_u128::wrapping_sub(arg0.fee_growth_global_a, v5.fee_growth_outside_a), cetus::math_u128::wrapping_sub(arg0.fee_growth_global_b, v5.fee_growth_outside_b))
            } else {
                (v5.fee_growth_outside_a, v5.fee_growth_outside_b)
            }
        };
        let (v6, v7) = if (0x1::option::is_none<Tick>(&v1)) {
            (0, 0)
        } else {
            let v8 = 0x1::option::borrow<Tick>(&v1);
            if (cetus::i64::lt(v2, arg2)) {
                (v8.fee_growth_outside_a, v8.fee_growth_outside_b)
            } else {
                (cetus::math_u128::wrapping_sub(arg0.fee_growth_global_a, v8.fee_growth_outside_a), cetus::math_u128::wrapping_sub(arg0.fee_growth_global_b, v8.fee_growth_outside_b))
            }
        };
        (cetus::math_u128::wrapping_sub(cetus::math_u128::wrapping_sub(arg0.fee_growth_global_a, v3), v6), cetus::math_u128::wrapping_sub(cetus::math_u128::wrapping_sub(arg0.fee_growth_global_b, v4), v7))
    }
    ...
    public fun get_position_tick_range<T0, T1>(arg0: address, arg1: u64) : (cetus::i64::I64, cetus::i64::I64) acquires Pool {
        let v0 = borrow_global<Pool<T0, T1>>(arg0);
        if (!0x1::table::contains<u64, Position>(&v0.positions, arg1)) {
            abort 29
        };
    ...
    public fun get_position_tick_range_by_pool<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : (cetus::i64::I64, cetus::i64::I64) {
    ...
    fun get_reward_in_tick_range<T0, T1>(arg0: &Pool<T0, T1>, arg1: cetus::i64::I64, arg2: cetus::i64::I64) : vector<u128> {
        let v0 = borrow_tick<T0, T1>(arg0, arg1);
        let v1 = borrow_tick<T0, T1>(arg0, arg2);
        let v2 = arg0.current_tick_index;
        ...
        while (v4 < 0x1::vector::length<Rewarder>(&arg0.rewarder_infos)) {
            ...
            let v6 = if (0x1::option::is_none<Tick>(&v0)) {
                ...
                cetus::math_u128::wrapping_sub(v5, *0x1::vector::borrow<u128>(&0x1::option::borrow<Tick>(&v0).rewarders_growth_outside, v4))
            } else {
            ...
            let v7 = if (0x1::option::is_none<Tick>(&v1)) {
                ...
                *0x1::vector::borrow<u128>(&0x1::option::borrow<Tick>(&v1).rewarders_growth_outside, v4)
                ...
                cetus::math_u128::wrapping_sub(v5, *0x1::vector::borrow<u128>(&0x1::option::borrow<Tick>(&v1).rewarders_growth_outside, v4))
            };
            0x1::vector::push_back<u128>(&mut v3, cetus::math_u128::wrapping_sub(cetus::math_u128::wrapping_sub(v5, v6), v7));
            v4 = v4 + 1;
        };
        v3
    }
    ...
    public fun open_position<T0, T1>(arg0: &signer, arg1: address, arg2: cetus::i64::I64, arg3: cetus::i64::I64) : u64 acquires Pool {
        ...
        0x1::table::add<u64, Position>(&mut v0.positions, v0.position_index, new_empty_position(arg1, arg2, arg3, v0.position_index));
    ...
    public fun remove_liquidity<T0, T1>(arg0: &signer, arg1: address, arg2: u128, arg3: u64) : (0x1::coin::Coin<T0>, 0x1::coin::Coin<T1>) acquires Pool {
        assert!(arg2 != 0, 11);
        ...
        let (v6, v7) = cetus::clmm_math::get_amount_by_liquidity(v1, v2, v0.current_tick_index, v0.current_sqrt_price, arg2, false);
    ...
    public fun repay_add_liquidity<T0, T1>(arg0: 0x1::coin::Coin<T0>, arg1: 0x1::coin::Coin<T1>, arg2: AddLiquidityReceipt<T0, T1>) acquires Pool {
    ...
    public fun repay_flash_swap<T0, T1>(arg0: 0x1::coin::Coin<T0>, arg1: 0x1::coin::Coin<T1>, arg2: FlashSwapReceipt<T0, T1>) acquires Pool {
    ...
    public fun reset_init_price_v2<T0, T1>(arg0: &signer, arg1: address, arg2: u128) acquires Pool {
        ...
        let v0 = borrow_global_mut<Pool<T0, T1>>(arg1);
        assert!(arg2 > cetus::tick_math::get_sqrt_price_at_tick(tick_min(v0.tick_spacing)) && arg2 < cetus::tick_math::get_sqrt_price_at_tick(tick_max(v0.tick_spacing)), 38);
    ...
    public fun transfer_rewarder_authority<T0, T1>(arg0: &signer, arg1: address, arg2: u8, arg3: address) acquires Pool {
        let v0 = 0x1::signer::address_of(arg0);
        let v1 = borrow_global_mut<Pool<T0, T1>>(arg1);
        assert_status<T0, T1>(v1);
        assert!((arg2 as u64) < 0x1::vector::length<Rewarder>(&v1.rewarder_infos), 23);
    ...
    fun update_pool_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool) : u64 {
        ...
        if (arg4) {
            arg0.fee_growth_global_a = cetus::math_u128::wrapping_add(arg0.fee_growth_global_a, ((v1 as u128) << 64) / arg0.liquidity);
        } else {
            arg0.fee_growth_global_b = cetus::math_u128::wrapping_add(arg0.fee_growth_global_b, ((v1 as u128) << 64) / arg0.liquidity);
        };
        v2
    }
    ...
    fun update_position_fee(arg0: &mut Position, arg1: u128, arg2: u128) {
        let (v0, v1) = cetus::math_u64::overflowing_add(arg0.fee_owed_a, (cetus::full_math_u128::mul_shr(arg0.liquidity, cetus::math_u128::wrapping_sub(arg1, arg0.fee_growth_inside_a), 64) as u64));
        let (v2, v3) = cetus::math_u64::overflowing_add(arg0.fee_owed_b, (cetus::full_math_u128::mul_shr(arg0.liquidity, cetus::math_u128::wrapping_sub(arg2, arg0.fee_growth_inside_b), 64) as u64));
        assert!(!v1, 35);
        assert!(!v3, 35);
        arg0.fee_owed_a = v0;
        arg0.fee_owed_b = v2;
    ...
    fun update_position_rewarder(arg0: &mut Position, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg1)) {
            ...
            v2.growth_inside = v1;
            let (v3, v4) = cetus::math_u64::overflowing_add(v2.amount_owed, (cetus::full_math_u128::mul_shr(cetus::math_u128::wrapping_sub(v1, v2.growth_inside), arg0.liquidity, 64) as u64));
            assert!(!v4, 34);
            v2.amount_owed = v3;
            v0 = v0 + 1;
        };
    ...
    fun update_rewarder<T0, T1>(arg0: &mut Pool<T0, T1>) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarder_infos)) {
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarder_infos, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarder_infos, v2).growth_global + cetus::full_math_u128::mul_div_floor(((v0 - v1) as u128), 0x1::vector::borrow<Rewarder>(&arg0.rewarder_infos, v2).emissions_per_second, arg0.liquidity);
            v2 = v2 + 1;
        };
    }
    ...
    fun upsert_tick_by_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: cetus::i64::I64, arg2: u128, arg3: bool, arg4: bool) {
